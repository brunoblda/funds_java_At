...
public class SacolaDeComprasTest {
	...
	public static void main(String[] args) {
		...
		Comprador compradorC1 = new Comprador(1, "bruno Luiz", "11122233355", "email@email.com", "61998845522");
		
		SacolaDeCompras p1 = new SacolaDeCompras("Sacola do bruno", compradorC1);
